...
$sql = "SELECT isDeleted, itemID, itemName, displayName, price, small, medium, large, factor, categoryID FROM item";
        ...
        if($row["isDeleted"] == true)
            {
                ...
                if($categoryName != "redistribution")
                {
                    ...
                    echo "<td>". $row["itemID"]. "</td><td>". $row["itemName"]. "</td><td>" . $row["displayName"] . "</td><td>" . $row["price"] . "</td><td>" . $row["small"] . "</td><td>" . $row["medium"] . "</td><td>" . $row["large"] . "</td>" . $row["categoryID"] . "</td><td>$categoryName</td>";
