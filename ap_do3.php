...
<body>
	...
	<button id='btn_back' onclick="goBack()">Back</button>    <form name="createDonationPartner" action="php/donationOps.php" onSubmit="return validateDonationPartnerAdd()" method="post">
