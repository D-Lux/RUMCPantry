...
if ($resultCount > 0) {
  ...
  foreach ($results as $result) {
    ...
    echo "<td>";
      echo "<button type='submit' class='btn-edit' name='noShow'><i class='fa fa-eye-slash'></i> No Show</button>";
      echo "<button type='submit' class='btn-edit' name='documentation'><i class='fa fa-file'></i> Bad Documentation</button>";
      echo "<button type='submit' class='btn-edit' name='cancelled'><i class='fa fa-ban'></i> Cancelled </button>";
    echo "</td>";
    echo "</form>";
    echo "</tr>";    
