...
?>
	...
	<form name="submitNewRedist" action="php/redistOps.php" onSubmit="return validateNewPartner()" method="post">
		<div class="inputDiv">
			<div id="partnerName" class="required"><label for="partnerNameField">Partner Name:</label>
			<input type="text" id="partnerNameField" name="partnerName" maxlength="45"></div><br>
			...
			<label for="addressZipField">Zip Code:</label> <input id="addressZipField" type="number" name="addressZip">
		</div> <!-- </inputDiv> -->
